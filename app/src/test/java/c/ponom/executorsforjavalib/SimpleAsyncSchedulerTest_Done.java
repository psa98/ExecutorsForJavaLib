    ...
    public void testLaunchTasksRunnable() throws InterruptedException {
        ...
        */
        ...
        for (int batch = 1; batch != REPETITIONS_COUNTER; batch++) {
            ...
            SimpleAsyncScheduler.launchTasks((int) (10 * random() + 1), unitTestListCallable)
                    .awaitTermination(TIMEOUT, TimeUnit.MILLISECONDS);
            ...
            SimpleAsyncScheduler.launchTasks((int) (10 * random() + 1), unitTestListRunnable)
                    .awaitTermination(TIMEOUT, TimeUnit.MILLISECONDS);
            ...
            assertEquals(TARGET_TASKS_COUNT*2*2, commonArray.size());
